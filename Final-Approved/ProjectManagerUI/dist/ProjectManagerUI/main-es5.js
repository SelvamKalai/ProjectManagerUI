...
var AddTasksComponent = /** @class */ (function () {
    ...
    AddTasksComponent.prototype.openProjectDialog = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(_model_popup_project_list_model_project_list_model_component__WEBPACK_IMPORTED_MODULE_6__["ProjectListModelComponent"], this.projectList)
            .subscribe(function (selectedProject) {
            if (selectedProject) {
                _this.ProjectID = selectedProject.ProjectID;
                _this.ProjectName = selectedProject.ProjectName;
            }
        });
        setTimeout(function () {
    ...
    AddTasksComponent.prototype.openParentTaskDialog = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(_model_popup_task_list_model_task_list_model_component__WEBPACK_IMPORTED_MODULE_7__["TaskListModelComponent"], this.parentTaskList)
            .subscribe(function (selectedTask) {
            if (selectedTask) {
                _this.ParentTaskID = selectedTask.ParentTaskID;
                _this.ParentTaskName = selectedTask.ParentTaskName;
            }
        });
        setTimeout(function () {
            disposable.unsubscribe();
    ...
    AddTasksComponent.prototype.openUserDialog = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(_model_popup_user_list_model_user_list_model_component__WEBPACK_IMPORTED_MODULE_5__["UserListModelComponent"], this.UserList)
...
var ProjectListModelComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ProjectListModelComponent, _super);
    ...
    ProjectListModelComponent.prototype.SelectProject = function (project) {
        var projectModel = new _models_project_model__WEBPACK_IMPORTED_MODULE_3__["ProjectModel"]();
    ...
    ProjectListModelComponent.prototype.filterItem = function () {
        ...
        if (!this.searchText)
            this.assignCopy();
        this.filteredList = Object.assign([], this.projectList).filter(function (item) { return (item.ProjectName != undefined ? item.ProjectName.toLowerCase().indexOf(_this.searchText.toLowerCase()) > -1 : true); });
    };
    ...
    ProjectListModelComponent.ctorParameters = function () { return [
...
var TaskListModelComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](TaskListModelComponent, _super);
    ...
    TaskListModelComponent.prototype.SelectTask = function (task) {
        var taskModel = new _models_task_model__WEBPACK_IMPORTED_MODULE_3__["ParentTaskModel"]();
    ...
    TaskListModelComponent.prototype.filterItem = function () {
        ...
        if (!this.searchText)
            this.assignCopy();
        this.filteredList = Object.assign([], this.parentTaskList).filter(function (item) { return (item.ParentTaskName != undefined ? item.ParentTaskName.toLowerCase().indexOf(_this.searchText.toLowerCase()) > -1 : true); });
    };
    ...
    TaskListModelComponent.ctorParameters = function () { return [
        { type: ng2_bootstrap_modal__WEBPACK_IMPORTED_MODULE_2__["DialogService"] },
        { type: _service_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }
    ]; };
...
var UserListModelComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](UserListModelComponent, _super);
    ...
    UserListModelComponent.prototype.SelectUser = function (user) {
        var userModel = new _models_user_model__WEBPACK_IMPORTED_MODULE_3__["UserModel"]();
    ...
    UserListModelComponent.ctorParameters = function () { return [
        { type: ng2_bootstrap_modal__WEBPACK_IMPORTED_MODULE_2__["DialogService"] },
        { type: _service_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }
    ]; };
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.GetUsers = function () {
        ...
        return this._http.get(getUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (response) { return response.json(); }))
...
var UsersComponent = /** @class */ (function () {
    ...
    UsersComponent.prototype.DeleteUser = function (user) {
        var _this = this;
        var obj = new _models_user_model__WEBPACK_IMPORTED_MODULE_2__["UserModel"]();
...
var ViewTasksComponent = /** @class */ (function () {
    ...
    ViewTasksComponent.prototype.openProjectDialog = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(_model_popup_project_list_model_project_list_model_component__WEBPACK_IMPORTED_MODULE_3__["ProjectListModelComponent"], this.projectList)
            .subscribe(function (selectedProject) {
            if (selectedProject) {
                _this.ProjectID = selectedProject.ProjectID;
                _this.ProjectName = selectedProject.ProjectName;
    ...
    ViewTasksComponent.ctorParameters = function () { return [
